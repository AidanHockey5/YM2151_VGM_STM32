...
Or you can sign-in to Digikey and view the parts here: https://www.digikey.com/BOM/View?id=7524544

Also, the 1000uF capacitors (C25, C24, C23) are actually have 2.5mm pin spacing, but Digikey only had 3.5mm spaced 8mm diameter caps. The fit isn't exactly perfect, but it's close enough to work.
